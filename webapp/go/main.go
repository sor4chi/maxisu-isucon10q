...
func searchEstateNazotte(c echo.Context) error {
	...
	query := fmt.Sprintf(`SELECT * FROM estate WHERE ST_INTERSECTS(ST_PolygonFromText(%s), point) ORDER BY popularity DESC, id ASC LIMIT ?`, coordinates.coordinatesToText())
